...
**전체 분석 결과를 보려면 백엔드(Spring Boot)와 AI 서버도 함께 실행해야 전체 기능이 동작. 백엔드와 자동으로 연동되도록 해놨으므로 따로 react 서버를 실행할 필요는 없음**
+ 비언어 분석이 될 때도 있고 안 될 때도 있어서 python-AI의 main.py에서 주석처리 해놨으니 유의
