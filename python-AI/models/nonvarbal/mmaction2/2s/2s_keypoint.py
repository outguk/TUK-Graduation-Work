...
checkpoint_file = '../mmpose/hrnet_w48_coco_256x192-b9e0b3ab_20200708.pth'
...
# 실행
input_dir = "../mmpose/raw_data"  # 입력 이미지 디렉토리

output_dir = "../mmpose/keypoints"  # JSON 및 .pkl 결과 저장 디렉토리
vis_dir = "../mmpose/visualizations"  # keypoints 시각화된 이미지 저장 디렉토리
